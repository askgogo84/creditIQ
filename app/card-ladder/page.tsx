...
const LADDER = [
  {
    ...
    cards: [
      { name: 'Amazon Pay ICICI', fee: 'Free', why: '5% on Amazon, 2% on partners, no annual fee. Best first card if you shop on Amazon.', slug: 'icici-amazon-pay' },
  ...
  },
  {
    ...
    cards: [
      ...
      { name: 'HDFC Swiggy BLCK', fee: 'Rs.500', why: '10% on Swiggy food + Instamart. If you order 3+ times a week, this card pays for itself monthly.', slug: 'hdfc-swiggy' },
  ...
  },
  {
    ...
    cards: [
      ...
      { name: 'ICICI Emeralde Private Metal', fee: 'Rs.12,499', why: 'Up to 36% on iShop hotel bookings. Unlimited lounges. Strong if you\'re in the ICICI ecosystem.', slug: 'icici-emeralde' },
