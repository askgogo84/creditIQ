...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--bg, #08080E)' }}>
      <div className="w-full max-w-md rounded-2xl p-8 flex flex-col gap-6"
        style={{ background: 'var(--card, #111118)', border: '1px solid var(--border, rgba(255,255,255,0.08))' }}>
        ...
        <div className="rounded-xl p-4" style={{ background: 'rgba(201,151,46,0.06)', border: '1px solid rgba(201,151,46,0.15)' }}>
          <p className="text-xs font-medium mb-2" style={{ color: 'rgba(201,151,46,0.8)' }}>No account needed for:</p>
