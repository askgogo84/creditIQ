...
const TERMS = [
  ...
  { term: 'Base Reward Rate', def: 'The standard percentage of spend returned as rewards on non-category purchases. E.g. 1% means ₹1 back per ₹100 spent.' },
  ...
  { term: 'Devaluation', def: 'When a bank reduces the benefits of a credit card — cutting reward rates, adding caps, gating lounge access, or increasing fees — without changing the card name.' },
  ...
  { term: 'Fee Waiver', def: 'Many cards waive the annual fee if you spend above a certain amount in a year. E.g. HDFC Regalia Gold waives ₹2,500 fee on ₹4L annual spend.' },
  ...
  { term: 'Fuel Surcharge Waiver', def: 'Most credit cards charge 1% surcharge on fuel purchases. Cards with this benefit waive it, saving ₹10-50 per fill-up.' },
  ...
  { term: 'Milestone Bonus', def: 'Extra rewards earned when cumulative spend hits a threshold. E.g. Amex gives 7,700 bonus MR points on ₹1.9L annual spend.' },
  ...
  { term: 'NeuCoins', def: 'Tata Neu app\'s reward currency, worth ₹1 each within the Tata ecosystem (BigBasket, Croma, 1mg, Westside, Air Asia).' },
  ...
  { term: 'Redemption Haircut', def: 'The value lost when redeeming points for low-value options like catalog items or cashback. E.g. HDFC points worth ₹1.80 via KrisFlyer are worth only ₹0.30 as cashback.' },
...
export const metadata = {
  title: 'Credit Card Glossary · CardIQ',
