...
const TERMS = [
  ...
  { term: 'Redemption Haircut', def: 'The value lost when redeeming points for low-value options like catalog items or cashback. E.g. HDFC points worth Rs.1.80 via KrisFlyer are worth only Rs.0.30 as cashback.' },
