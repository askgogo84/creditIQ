...
export const metadata: Metadata = {
  ...
  description: 'Every credit card term explained simply. APR, reward rate, forex markup, devaluation, milestone bonus, lounge access â€” 30+ terms for Indian credit cards.',
