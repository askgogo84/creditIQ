...
const PROGRAMS = [
  ...
  { id: 'intermiles', name: 'IndiGo 6E Rewards', airline: 'IndiGo', type: 'airline', color: '#0048DB', logo: 'IG', expiryMonths: 24, expiryNote: 'Miles expire 24 months from earning date', valuePerPoint: 0.5, transferFrom: ['HDFC', 'ICICI', 'SBI'], sweetSpot: 'BLR-DEL domestic: 8,000 miles one-way', loginUrl: 'https://www.goindigo.in/6e-rewards.html' },
