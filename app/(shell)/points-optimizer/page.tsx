                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p style={{ margin: 0, fontSize: 11, color: active ? 'color-mix(in srgb, var(--paper) 62%, transparent)' : 'var(--ink-4)', lineHeight: 1.4 }}>{g.desc}</p>
                      </div>
                    </button>
                  );
                })}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {result && (
              <>
                {/* AI Strategy banner */}
                {aiStrategy && (
                  <div style={{ background: 'var(--navy)', borderRadius: 16, padding: '16px 18px' }}>
