...
const MORE_CARDS: CreditCard[] = [
  ...
  // ===== ICICI =====
  { id: 'icici-sapphiro', slug: 'icici-sapphiro', name: 'ICICI Bank Sapphiro Credit Card', bank: 'ICICI', category: ['premium','travel','lifestyle'], tier: 'premium', joining_fee_inr: 6500, annual_fee_inr: 3500, fee_waiver_spend_inr: 600000, min_income_inr_monthly: 120000, credit_score_min: 750, reward_currency: 'reward-points', base_reward_rate: 2, category_rewards: [{ category: 'international', rate: 4, unit: 'multiplier' },{ category: 'dining', rate: 2, unit: 'multiplier' }], welcome_benefit_inr: 9000, welcome_benefit_description: 'Gift vouchers worth ₹9,000', lounges: [{ type: 'domestic', network: 'priority-pass', visits_per_year: 4 },{ type: 'international', network: 'priority-pass', visits_per_year: 4 }], forex_markup_percent: 3.5, redemption_options: [{ type: 'cashback', value_per_point_inr: 0.25 },{ type: 'voucher', value_per_point_inr: 0.35 }], color: '#1e40af', best_for: 'ICICI banking customers wanting premium benefits', highlights: ['₹9K welcome vouchers','Priority Pass lounges','4X international'], expert_rating: 7.3, active: true, last_verified: '2026-05-01' },
  ...
  // ===== SBI more =====
  { id: 'sbi-simplyclick', slug: 'sbi-simplyclick', name: 'SBI Card SimplyCLICK', bank: 'SBI', category: ['cashback','shopping','entry-level'], tier: 'entry', joining_fee_inr: 499, annual_fee_inr: 499, fee_waiver_spend_inr: 100000, min_income_inr_monthly: 20000, reward_currency: 'reward-points', base_reward_rate: 0.25, category_rewards: [{ category: 'online-exclusive', rate: 10, unit: 'multiplier', notes: '10X on Amazon, BookMyShow, Cleartrip, Dominos, Lenskart, Netmeds, Swiggy' },{ category: 'online-others', rate: 5, unit: 'multiplier' }], welcome_benefit_inr: 500, welcome_benefit_description: '₹500 Amazon voucher', lounges: [], fuel_surcharge_waiver: true, redemption_options: [{ type: 'cashback', value_per_point_inr: 0.25 }], color: '#1d4ed8', best_for: 'Online shoppers on partner platforms', highlights: ['10X on 7 partner brands','5X on all other online','₹500 Amazon welcome'], expert_rating: 7.8, active: true, last_verified: '2026-05-01' },
  ...
  { id: 'sbi-air-india-signature', slug: 'sbi-air-india-signature', name: 'Air India SBI Signature', bank: 'SBI', category: ['travel','premium'], tier: 'premium', joining_fee_inr: 4999, annual_fee_inr: 4999, min_income_inr_monthly: 75000, reward_currency: 'miles', base_reward_rate: 1.5, category_rewards: [{ category: 'air-india', rate: 30, unit: 'multiplier', notes: '30 Flying Returns miles per ₹100 on Air India' }], welcome_benefit_inr: 5000, welcome_benefit_description: '20,000 Flying Returns miles on joining', lounges: [{ type: 'domestic', network: 'priority-pass', visits_per_year: 8 }], forex_markup_percent: 1.99, redemption_options: [{ type: 'flight', partner: 'Air India Flying Returns', value_per_point_inr: 0.50 }], color: '#991b1b', best_for: 'Frequent Air India travelers', highlights: ['30X miles on Air India','20K welcome miles'], expert_rating: 7.5, active: true, last_verified: '2026-05-01' },
  // ===== RBL more =====
...
const NEW_CARDS: CreditCard[] = [
  ...
  // SBI
  { id:'sbi-simplysave', slug:'sbi-simplysave', name:'SBI SimplySAVE', bank:'SBI', tier:'entry', joining_fee_inr:499, annual_fee_inr:499, base_reward_rate:0.25, color:'#1a3e8c', best_for:'Offline shoppers — grocery, dining, departmental stores', expert_rating:6.8, category:['shopping','entry-level'], reward_currency:'reward-points', active:true, last_verified:'2026-05-17', highlights:['10X rewards on grocery','Fee waiver on ₹1L spend'], redemption_options:[], category_rewards:[], lounges:[], devaluations:[], apr_percent:42, eligible_employment:['salaried','self-employed'], interest_free_days:50 },
