...
// Paste these into seed-cards.ts after the existing ICICI cards

  {
    ...
    bank: 'ICICI',
    category: ['super-premium', 'travel', 'premium', 'rewards'],
    tier: 'super-premium',
...

  {
    ...
    bank: 'ICICI',
    category: ['mid', 'travel', 'lifestyle', 'rewards'],
    tier: 'mid',
    joining_fee_inr: 3000,
    annual_fee_inr: 2000,
    fee_waiver_spend_inr: 300000,
...
// ===== AXIS =====
...

  {
    ...
    bank: 'Axis',
    category: ['super-premium', 'travel', 'premium', 'lifestyle'],
    tier: 'super-premium',
...
// ===== KOTAK =====

  {
    ...
    bank: 'Kotak',
    category: ['super-premium', 'travel', 'lifestyle'],
    tier: 'super-premium',
    joining_fee_inr: 10000,
    annual_fee_inr: 10000,
    fee_waiver_spend_inr: 1000000,
...
// ===== KIWI / SPECIAL PURPOSE =====
...

  {
    ...
    bank: 'HDFC',
    category: ['mid', 'travel', 'dining', 'rewards'],
    tier: 'mid',
    joining_fee_inr: 2500,
    annual_fee_inr: 2500,
    fee_waiver_spend_inr: 300000,
...
// ===== NEW CARDS BATCH 2 — Remaining banks =====
...

  {
    ...
    bank: 'OneCard',
    category: ['zero-fee', 'rewards', 'mid', 'lifestyle'],
    tier: 'mid',
    joining_fee_inr: 0,
    annual_fee_inr: 0,
    min_income_inr_monthly: 30000,
