const FLIGHT_SOURCE_TO_PROGRAMME: Record<string, string> = {
  ...
  'airasia-rewards': 'airasia-rewards',
  ...
  'royal-orchid-plus': 'thai-royal-orchid',
  'thai-royal-orchid': 'thai-royal-orchid',
  lotusmiles: 'lotusmiles',
  vietnamairlines: 'lotusmiles',
  qantas: 'qantas',
...
const HOTEL_CHAIN_RULES: Array<{ programmeId: string; tokens: string[] }> = [
  ...
  },
  {
    ...
    tokens: ['royalorchid', 'regenta', 'regentacentral', 'regentaresort', 'regentainn'],
  },
  {
    programmeId: 'postcard-sunshine-club',
    tokens: ['thepostcard', 'postcardhotel', 'postcardresort'],
  },
]
