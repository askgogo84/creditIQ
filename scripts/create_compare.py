import os
os.makedirs(r'app/compare/[slug1]-vs-[slug2]', exist_ok=True)

content = r"""import { notFound } from 'next/navigation'
...
export async function generateMetadata({ params }: { params: { 'slug1-vs-slug2': string } }) {
...
export default async function ComparePage({ params }: { params: { 'slug1-vs-slug2': string } }) {
  const raw = params['slug1-vs-slug2']
  const [slug1, slug2] = raw.split('-vs-')
...
with open(r'app/compare/[slug1]-vs-[slug2]/page.tsx', 'w', encoding='utf-8', newline='\n') as f:
    f.write(content)
print("OK: compare page created")
