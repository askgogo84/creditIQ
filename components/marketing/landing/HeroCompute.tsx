  ...
  return (
    <div style={{ minWidth: 0 }}>
      ...
      <h1 style={{ fontFamily: FR, fontWeight: 300, fontSize: 'clamp(40px,6.4vw,84px)', lineHeight: 1.02, letterSpacing: '-0.015em', color: '#f7f4ef', margin: '20px 0 0', textWrap: 'pretty' }}>
        Your cards <em style={{ fontStyle: 'italic', color: '#e8b45c' }}>leak</em>{' '}
        <LeakMeter floor={floor} ceiling={ceiling} /> every year.
      </h1>

      {/* Provenance sits below the completed sentence; the basis tracks the slider. */}
